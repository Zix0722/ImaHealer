...
extern BitmapFont* m_gameFont;

constexpr float WORLD_SIZE_X = 400.f;
constexpr float WORLD_SIZE_Y = 200.f;
constexpr float WORLD_CAMERA_SIZE_X = 1600.f;
constexpr float WORLD_CAMERA_SIZE_Y = 800.f;
...
constexpr float FLOOR_HEIGHT = 200.f;
constexpr float HEALER_MOVING_SPEED = 200.f;
